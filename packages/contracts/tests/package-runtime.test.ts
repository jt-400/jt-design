...
describe('@jt-design/contracts package runtime shape', () => {
  ...
  it('makes runtime exports importable through package exports', async () => {
    const contracts = await import('@jt-design/contracts');
    const connectionTest = await import('@jt-design/contracts/api/connectionTest');
    const research = await import('@jt-design/contracts/api/research');
    const critique = await import('@jt-design/contracts/critique');
