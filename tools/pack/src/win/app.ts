...
import { createCommandInvocation, createPackageManagerInvocation } from "@jt-design/platform";
...
async function buildWorkspaceArtifacts(config: ToolPackConfig): Promise<void> {
  ...
  try {
    await runPnpm(config, ["--filter", "@jt-design/web", "build"], { OD_WEB_OUTPUT_MODE: config.webOutputMode });
