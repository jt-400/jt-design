...
// tsconfig does not resolve the `@jt-design/contracts/api/chat` subpath
...
import type {
  ...
  FinalizeArtifactRef,
} from '@jt-design/contracts/api/finalize';
...
// canonical definitions live in @jt-design/contracts/api/finalize
