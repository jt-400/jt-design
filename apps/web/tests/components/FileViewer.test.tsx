...
describe('applyInspectOverridesToSource', () => {
  ...
  // Regression for tuatahi.art#362: if a source file has more than
  ...
  // Regression for tuatahi.art#362: the splicer must be HTML-aware
  ...
  // Regression for tuatahi.art#362: the splicer must look at real
...
describe('serializeInspectOverrides', () => {
  ...
  // Regression for tuatahi.art#362: standard deck slides ship as
...
// Regression for tuatahi.art#362: the host owns the inspect override
...
describe('parseInspectOverridesFromSource', () => {
  ...
  // Regression for tuatahi.art#362: hydration must require an
