...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'JT Design را راه‌اندازی کنید',
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به JT Design، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'JT Design را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید JT Design در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه JT Design — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه JT Design ارائه می‌شود — نیازی به دانلود نیست.',
